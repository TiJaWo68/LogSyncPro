...
public class AboutDialog extends JDialog {
	...
	private JPanel createLibrariesPanel() {
		...
		addLib(listPanel, "FlatLaf", "3.7", "Apache 2.0", "https://www.formdev.com/flatlaf/");
		addLib(listPanel, "MigLayout", "11.3", "BSD 3-Clause", "http://www.miglayout.com");
		addLib(listPanel, "Apache Commons Compress", "1.26.1", "Apache 2.0", "https://commons.apache.org/proper/commons-compress/");
		addLib(listPanel, "XZ for Java", "1.9", "Public Domain", "https://tukaani.org/xz/java.html");
		addLib(listPanel, "Apache Mina SSHD", "2.12.0", "Apache 2.0", "https://mina.apache.org/sshd-project/");
		addLib(listPanel, "Cuberact Swing Layout", "1.1.1", "Unknown", "https://cuberact.org");
		addLib(listPanel, "Logback Classic", "1.5.3", "EPL 1.0 / LGPL 2.1", "https://logback.qos.ch/");
		addLib(listPanel, "SLF4J", "For Logback", "MIT", "https://www.slf4j.org/");
