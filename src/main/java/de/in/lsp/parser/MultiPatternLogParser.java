...
/**
 * A LogParser that can handle log files with mixed pattern formats. It tries a list of delegates for each line.
 * 
			...
			while ((line = reader.readLine()) != null) {
				...
				if (newEntry != null) {
					if (lastEntry == null && !headerBuffer.isEmpty()) {
						...
						allEntries.add(new LogEntry(null, "", "", "", "", 0, combinedHeader, sourceName, combinedHeader));
						headerBuffer.clear();
					}
					lastEntry = newEntry;
