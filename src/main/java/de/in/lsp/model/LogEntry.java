...
/**
 * Represents a single log entry with timestamp, level, message, and source information. Supports natural ordering based on the timestamp.
 * 
...
public record LogEntry(LocalDateTime timestamp, String level, String thread, String loggerName, String ip, String message,
	...
	public String getSimpleLoggerName() {
		...
		// Handle cases like "DicomTagPattern.java:105" becoming "DicomTagPattern:105" by removing the standard file extension if it appears
		// before the line number separator
	...
	public String getSimpleThreadName() {
		...
		String clean = thread;
		// If it contains (), it's likely a method reference, take only the part before () and then the last segment
