...
public class LogDetailViewTest {
    ...
    void testSetEntryPopulatesFields() {
        ...
        // Access via reflection or component hierarchy traversal would be ideal,
        // but for now let's check basic structure.

        // Structure: BorderLayout.NORTH -> Header Panel
        // Header Panel: CENTER -> Meta Panel (WrapLayout)
        ...
        // Find Message Area
        // BorderLayout.CENTER -> JScrollPane -> Viewport -> JTextArea
    ...
    void testSetEntryRespectsCurrentFontSize() {
        ...
        LogEntry entry = new LogEntry(
                LocalDateTime.now(), "INFO", "main", "Logger", "127.0.0.1", "Msg", "src", "raw");
        view.setEntry(entry);
    ...
    void testLongSourceFieldNotTruncated() {
        ...
        LogEntry entry = new LogEntry(
                LocalDateTime.now(), "INFO", "main", "Logger", "127.0.0.1", "Msg", longSource, "raw");
        view.setEntry(entry);
