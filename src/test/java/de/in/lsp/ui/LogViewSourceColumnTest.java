...
/**
 * Tests for ensuring the Source column is only visible when multiple unique sources exist.
 * 
...
public class LogViewSourceColumnTest {
	...
	public void testSourceColumnHiddenForSingleSource() throws Exception {
		SwingUtilities.invokeAndWait(() -> {
			...
			entries.add(new LogEntry(LocalDateTime.now(), "INFO", "main", "Logger", "127.0.0.1", "Msg1", "file1.log", null));
			entries.add(new LogEntry(LocalDateTime.now(), "INFO", "main", "Logger", "127.0.0.1", "Msg2", "file1.log", null));
	...
	public void testSourceColumnVisibleForMultipleSources() throws Exception {
		SwingUtilities.invokeAndWait(() -> {
			...
			List<LogEntry> entries = new ArrayList<>();
			entries.add(new LogEntry(LocalDateTime.now(), "INFO", "main", "Logger", "127.0.0.1", "Msg1", "file1.log", null));
			entries.add(new LogEntry(LocalDateTime.now(), "INFO", "main", "Logger", "127.0.0.1", "Msg2", "file2.log", null));
