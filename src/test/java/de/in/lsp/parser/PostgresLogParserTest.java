...
public class PostgresLogParserTest {
        ...
        public void testMixedPostgresLogs() throws Exception {
                ...
                assertTrue(entries.get(1).message().contains("{ticks: 0, maint: 0, retry: 0}"),
                                "Entry 1 message missing content");
                assertTrue(entries.get(1).message().contains("continuation line"),
                                "Entry 1 message missing continuation");
